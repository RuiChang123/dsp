...
>> P(idential twin|twin)=P(twin|idential twin)*P(idential twin)/(P(twin|idential twin)*P(idential twin)+P(twin|fraternal twin)*P(fraternal twin))=1*(1/300)/(1*(1/300)+1*(1/125))=29.4%
